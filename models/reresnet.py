...
from models.init_weights import constant_init, kaiming_init
from torch.nn.modules.batchnorm import _BatchNorm

from models.enn_layers import FIELD_TYPE, build_norm_layer, conv1x1, conv3x3
...
def get_reresnet(depth=50, num_stages=4, frozen_stages=1, norm_eval=False, out_indices=(1,2,3)):
    '''
    frozen_stages : 表示冻结模型的层级，默认为1，表示ResNet网络的layer1和以前的网络均冻结参数，并且BN层药设置为eval模式
    norm_eval:在训练状态下，是否让BN层处于eval模式
    '''
    pretrained = "/home/lab/ckq/S2ANet/re_resnet50_c8_batch256-25b16846.pth"

    # out_indices=(1,2,3)分别表示layer2,layer3，layer4的输出
    clasify_model = ReResNet(depth=depth, num_stages=num_stages, out_indices=out_indices, frozen_stages=frozen_stages, norm_eval=norm_eval, style='pytorch')
    ...
    # k1 = state_dict.keys()
    # k2 = clasify_model.state_dict().keys()
